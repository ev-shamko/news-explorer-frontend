export default class FormValidator {
    constructor(objParams) {
        this._formClass = objParams.formClass;
        this._formInputsClass = objParams.formInputsClass;
        this._submitButtonClass = objParams.submitButtonClass
        ...
        this._arrAllInputs = [...this._formClass.querySelectorAll(this._formInputsClass)]; //массив со всеми инпутами формы
        this._submitButton = this._formClass.querySelector(this._submitButtonClass);
